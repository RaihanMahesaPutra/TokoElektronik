...
<body class="font-sans bg-gray-100">
    <nav class="bg-white shadow-md sticky top-0 z-50">
        <div class="container mx-auto px-4 py-3 flex justify-between items-center">
          <!-- Logo -->
          <a href="#" class="text-3xl font-extrabold text-blue-600">Toko Elektronik 88</a>
      
          <!-- Desktop Menu -->
          <ul class="hidden md:flex space-x-8 text-lg font-medium">
            <li><a href="#" class="text-gray-600 hover:text-cyan-500 transition duration-300">Home</a></li>
            <li><a href="#" class="text-gray-600 hover:text-cyan-500 transition duration-300">Shop</a></li>
            <li><a href="#" class="text-gray-600 hover:text-cyan-500 transition duration-300">Delivery</a></li>
            <li><a href="#" class="text-gray-600 hover:text-cyan-500 transition duration-300">About</a></li>
            <li><a href="#" class="text-gray-600 hover:text-cyan-500 transition duration-300">Contact</a></li>
          </ul>
        ...
        <div id="mobile-menu" class="md:hidden hidden px-4 pb-4">
          <ul class="flex flex-col space-y-2 text-base font-medium">
            <li><a href="#" class="block text-gray-600 hover:text-cyan-500 transition duration-300">Home</a></li>
            <li><a href="#" class="block text-gray-600 hover:text-cyan-500 transition duration-300">Shop</a></li>
            <li><a href="#" class="block text-gray-600 hover:text-cyan-500 transition duration-300">Delivery</a></li>
            <li><a href="#" class="block text-gray-600 hover:text-cyan-500 transition duration-300">About</a></li>
            <li><a href="#" class="block text-gray-600 hover:text-cyan-500 transition duration-300">Contact</a></li>
          </ul>
        </div>
