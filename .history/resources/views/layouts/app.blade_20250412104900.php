...
<body class="font-sans bg-white-100">
  ...
  <div id="main-content" class="hidden">
    ...
    <div class="relative w-full overflow-hidden max-w-6xl mx-auto mt-6">
      <!-- Container untuk semua slide -->
      <div id="slider" class="flex transition-transform duration-500 ease-in-out">
        <img src="/images/image1.png" class="w-full flex-shrink-0" alt="Promo 1">
        <img src="/images/image2.png" class="w-full flex-shrink-0" alt="Promo 2">
        <img src="/images/image3.png" class="w-full flex-shrink-0" alt="Promo 3">
      </div>
    
      <!-- Tombol Geser -->
      <button onclick="slideLeft()" class="absolute left-2 top-1/2 -translate-y-1/2 bg-white rounded-full p-2 shadow hover:bg-gray-100">
        ◀
      </button>
      <button onclick="slideRight()" class="absolute right-2 top-1/2 -translate-y-1/2 bg-white rounded-full p-2 shadow hover:bg-gray-100">
        ▶
      </button>
    </div>
