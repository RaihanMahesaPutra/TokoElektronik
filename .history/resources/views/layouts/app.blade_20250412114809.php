...
<body class="font-sans bg-white-100">
  ...
  <div id="main-content" class="hidden">
    ...
    <nav class="bg-white shadow-md fixed top-0 w-full z-50 border-b">
      <!-- Baris Atas -->
      <div class="max-w-7xl mx-auto px-4 md:px-6 py-3 flex items-center justify-between relative h-16">
        
        <!-- Logo -->
        <div class="text-2xl font-bold text-blue-600 tracking-wide">TokoElektronik</div>
    
        <!-- Kategori di tengah secara vertikal -->
        <div class="absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2">
          ...
          <!-- Dropdown -->
          <div id="dropdownKategori" class="hidden absolute top-full left-1/2 transform -translate-x-1/2 bg-white shadow-xl rounded-lg mt-2 w-64 z-50 max-h-96 overflow-y-auto border">
