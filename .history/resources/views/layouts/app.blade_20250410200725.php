...
<body class="font-sans bg-gray-100">
    ...
    <footer class="bg-[#002f47] text-white pt-10 pb-6 px-6">
        <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10 text-sm border-b border-gray-600 pb-8">
          ...
          <!-- Logo & Lokasi -->
          <div>
            <h1 class="text-xl font-bold mb-2">Lifestyle</h1>
            <p class="text-gray-300">
              Jl. Magelang No.5 km 5, Kutu Tegal, Sinduadi, Sleman, Yogyakarta 55284
            </p>
            <a href="#" class="text-green-400 hover:underline block mt-2">Google Map</a>
            <p class="mt-4 font-semibold text-white">Buka setiap hari:</p>
            <p class="text-gray-300">Senin – Minggu: 09:00 – 21:30</p>
          </div>
      
          <!-- My Account -->
          <div>
            <h2 class="text-white font-semibold mb-3">My Account</h2>
            <ul class="space-y-2">
          ...
          <!-- Customer Service -->
          <div>
            <h2 class="text-white font-semibold mb-3">Customer Service</h2>
            <ul class="space-y-2">
          ...
          <!-- Contact -->
          <div>
            <h2 class="text-white font-semibold mb-3">Contact</h2>
            <ul class="space-y-2">
        ...
        <div class="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between pt-6 text-sm text-gray-400">
          <p>&copy; 2025 Lifestyle. All rights reserved.</p>
