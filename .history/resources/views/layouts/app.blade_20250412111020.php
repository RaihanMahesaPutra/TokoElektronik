...
<body class="font-sans bg-white-100">
  ...
  <div id="main-content" class="hidden">
    <!-- Navbar -->
<nav class="bg-white/90 backdrop-white-md shadow-md fixed top-0 w-full z-50 border-b border-gray-200">
  <!-- Baris Atas -->
  ...
  <div class="bg-white border-t border-gray-200 py-2">
    <div class="max-w-7xl mx-auto px-4 md:px-6">
      <div class="flex justify-end">
        <div class="flex items-center bg-gray-100 px-3 py-1 rounded-full w-full md:w-80">
          <input type="text" placeholder="Cari..." class="bg-transparent outline-none w-full text-sm">
