...
<body class="font-sans bg-gray-100">
    ...
    <footer class="bg-[#002f47] text-white px-6 py-10">
  <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 text-sm">
    
    <!-- Lokasi -->
    <div>
      <h2 class="font-semibold text-white mb-2">Lifestyle <span class="font-light">Jl Mojo Jl Magelang</span></h2>
      <p class="text-gray-300">
        Jl. Magelang No.5 km 5, Kutu Tegal, Sinduadi, Kec. Mlati, Kabupaten Sleman, Daerah Istimewa Yogyakarta 55284
      </p>
      <a href="#" class="text-green-400 hover:underline block mt-2">Google Map</a>
      <p class="mt-4 text-white font-semibold">Buka setiap hari :</p>
      <p class="text-gray-300">Senin – Minggu: 09:00 – 21:30</p>
    </div>

    <!-- My Account -->
    <div>
      <h2 class="font-semibold mb-2 text-2xl">My account</h2>
      <ul class="space-y-1">
        <li><a href="#" class="text-green-400 hover:underline">&rsaquo; My orders</a></li>
        <li><a href="#" class="text-green-400 hover:underline">&rsaquo; My returns</a></li>
        <li><a href="#" class="text-green-400 hover:underline">&rsaquo; My information</a></li>
        <li><a href="#" class="text-green-400 hover:underline">&rsaquo; My email preferences</a></li>
      </ul>
    </div>

    <!-- Customer Service -->
    <div>
      <h2 class="font-semibold mb-2 text-2xl">Customer service</h2>
      <ul class="space-y-1">
        <li><a href="#" class="text-green-400 hover:underline">&rsaquo; Pembayaran</a></li>
        <li><a href="#" class="text-green-400 hover:underline">&rsaquo; FAQ</a></li>
        <li><a href="#" class="text-green-400 hover:underline">&rsaquo; Lokasi Toko</a></li>
        <li><a href="#" class="text-green-400 hover:underline">&rsaquo; Kebijakan Privasi</a></li>
      </ul>
    </div>

    <!-- Contact -->
    <div>
      <h2 class="font-semibold mb-2 text-2xl">Contact</h2>
      <ul class="space-y-1 text-2xl">
        <li><a href="#" class="text-green-400 hover:underline">&rsaquo; About us</a></li>
        <li><a href="#" class="text-green-400 hover:underline">&rsaquo; Services</a></li>
        <li><a href="#" class="text-green-400 hover:underline">&rsaquo; Blog</a></li>
        <li><a href="#" class="text-green-400 hover:underline">&rsaquo; Contact</a></li>
      </ul>
    </div>
