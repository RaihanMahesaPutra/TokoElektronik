...
<body class="font-sans bg-white-100">
  ...
  <div id="main-content" class="hidden">
    ...
    <div class="relative w-full overflow-hidden max-w-5xl mx-auto pt-24">
      ...
      class="absolute left-2 top-1 -translate-y-1/2 bg-white text-gray-700 rounded-full p-3 shadow-lg hover:bg-gray-200 hover:scale-110 transition-all duration-300 ease-in-out">
      <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7" />
      </svg>
      </button>
      <button onclick="slideRight()"
      class="absolute right-2 top-1 -translate-y-1/2 bg-white text-gray-700 rounded-full p-3 shadow-lg hover:bg-gray-200 hover:scale-110 transition-all duration-300 ease-in-out">
      <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
