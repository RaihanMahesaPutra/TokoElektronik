...
<body class="font-sans bg-white-100">
  ...
  <div id="main-content" class="hidden">
    <nav class="bg-white/90 backdrop-blur-md shadow-md fixed top-0 w-full z-50 border-b border-gray-200">
      <div class="max-w-7xl mx-auto px-4 md:px-6 py-3 flex items-center justify-between">
        ...
        <div class="flex flex-col">
          <span class="text-2xl font-black text-black leading-none">Atakrib</span>
          <span class="text-sm text-gray-600 -mt-1">Elektronik Yogyakarta</span>
        </div>
        ...
        <div class="flex items-center space-x-6">
          <!-- Kategori Dropdown -->
          <div class="relative">
            <button onclick="toggleKategori()" class="flex items-center gap-1 text-sm text-blue-600 font-medium hover:text-blue-800 transition">
              Pilih <span class="font-bold">Kategori</span>
          ...
          <!-- Menu utama -->
          <ul class="hidden md:flex space-x-6 font-medium text-sm text-gray-800">
            <li><a href="#" class="hover:text-blue-600 transition">Shop By Store</a></li>
            <li><a href="#" class="hover:text-blue-600 transition">Shop by Product</a></li>
        ...
        <div class="flex items-center space-x-4">
          <!-- Tombol -->
          <a href="#" class="border border-black px-4 py-1 rounded-full text-sm font-medium hover:bg-black hover:text-white transition">
            Ready to Shop
          </a>
          <!-- Icon User -->
          <a href="#" class="text-black hover:text-blue-500 transition">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              <path d="M12 12c2.7 0 4.9-2.2 4.9-4.9S14.7 2.2 12 2.2 7.1 4.4 7.1 7.1 9.3 12 12 12zm0 2.4c-3.3 0-9.9 1.6-9.9 4.9v2.5h19.8v-2.5c0-3.3-6.6-4.9-9.9-4.9z"/>
            </svg>
          </a>
          <!-- Search Bar -->
          <div class="hidden md:flex items-center bg-gray-100 px-3 py-1 rounded-full w-72">
    ...
    <div class="relative w-full overflow-hidden max-w-5xl mx-auto pt-24">
      ...
      class="absolute left-2 top-1/2 -translate-y-1/2 bg-white text-gray-700 rounded-full mt-10 p-3 shadow-lg hover:bg-gray-200 hover:scale-110 transition-all duration-300 ease-in-out">
      <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7" />
      </svg>
      </button>
      <button onclick="slideRight()"
      class="absolute right-2 top-1/2 -translate-y-1/2 bg-white text-gray-700 rounded-full mt-10 p-3 shadow-lg hover:bg-gray-200 hover:scale-110 transition-all duration-300 ease-in-out">
      <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
