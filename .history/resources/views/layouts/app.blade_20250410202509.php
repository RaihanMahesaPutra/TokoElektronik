...
<body class="font-sans bg-gray-100">
    <nav class="bg-white/80 backdrop-blur-md shadow-sm py-3 fixed top-0 w-full z-50">
        <div class="container mx-auto px-6 flex items-center justify-between">
          
          <!-- Logo -->
          <div class="text-2xl font-bold text-gray-800">Lifestyle</div>
          
          <!-- Menu -->
          <ul class="hidden md:flex space-x-10 text-gray-700 font-medium text-lg">
            <li><a href="#" class="hover:text-teal-500 transition">Home</a></li>
            <li><a href="#" class="hover:text-teal-500 transition">Produk</a></li>
            <li><a href="#" class="hover:text-teal-500 transition">About</a></li>
            <li><a href="#" class="hover:text-teal-500 transition">Kontak</a></li>
          </ul>
      
          <!-- CTA -->
          <div class="hidden md:block">
            <a href="#" class="bg-teal-500 text-white px-4 py-2 rounded-xl hover:bg-teal-600 transition">Login</a>
          </div>
        </div>
      </nav>
