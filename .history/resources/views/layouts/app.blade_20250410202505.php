...
<body class="font-sans bg-gray-100">
  ...
  <div class="container mx-auto px-6 flex items-center justify-between">
    ...
    <div class="flex items-center space-x-4">
      <a href="#" class="text-gray-600 hover:text-teal-500 hidden md:inline">Login</a>
      <button class="relative">
        <svg class="w-6 h-6 text-gray-600 hover:text-teal-500" fill="none" stroke="currentColor" stroke-width="2"
          viewBox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round"
            d="M3 3h2l.4 2M7 13h10l1.4-6H6.6M7 13l-1.3 6h11.6L17 13M7 13L6 9m11 4l1 6m-5-6v6" />
        </svg>
        <span
  ...
  <div class="md:hidden px-6 pt-2 pb-4">
    <ul class="space-y-2 text-gray-600 font-medium">
      ...
      <li><a href="#" class="block">Produk</a></li>
